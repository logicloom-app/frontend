...
export default function DashboardClient({ lang, dict }) {
  ...
  return (
    <div className="px-4 py-8 w-full h-full overflow-auto max-h-[calc(100vh-10rem)]">
      <div className="max-w-7xl mx-auto">
        ...
        <BlurFade delay={0.2} inView>
          <div className="bg-gray-100 dark:bg-gray-800/60 backdrop-blur-xl border-2 border-gray-200/60 dark:border-gray-700/50 rounded-3xl p-6 md:p-8 mb-6 shadow-xl shadow-gray-200/50 dark:shadow-2xl dark:shadow-transparent relative overflow-hidden">
            {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-8">
          <BlurFade delay={0.3} inView>
            <div className="bg-gray-50 dark:bg-gray-800/60 backdrop-blur-xl border-2 border-gray-200/60 dark:border-gray-700/50 rounded-2xl p-6 shadow-lg shadow-gray-200/40 dark:shadow-none hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 hover:-translate-y-1">
          ...
          <BlurFade delay={0.4} inView>
            <div className="bg-gray-50 dark:bg-gray-800/60 backdrop-blur-xl border-2 border-gray-200/60 dark:border-gray-700/50 rounded-2xl p-6 shadow-lg shadow-gray-200/40 dark:shadow-none hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-4">
          ...
          <BlurFade delay={0.5} inView>
            <div className="bg-gray-50 dark:bg-gray-800/60 backdrop-blur-xl border-2 border-gray-200/60 dark:border-gray-700/50 rounded-2xl p-6 shadow-lg shadow-gray-200/40 dark:shadow-none hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center gap-4">

...
export default function DashboardSidebar({ dict, lang }) {
  ...
  const navItems = [
    { href: "/dashboard", icon: LayoutDashboard, label: dict?.dashboard || "Dashboard" },
    { href: "/dashboard/projects", icon: Folder, label: dict?.projects || "Projects" },
    { href: "/dashboard/requests", icon: FolderInput, label: dict?.requests || "Requests" },
    { href: "/dashboard/payments", icon: Euro, label: dict?.payments || "Payments" },
  ];

  const settingsItems = [
    { href: "/dashboard/password", icon: KeyRound, label: dict?.password || "Password" },
    { href: "/dashboard/info", icon: UserPen, label: dict?.info || "Info", hasNotification: !user?.phone_number },
  ];

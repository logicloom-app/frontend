          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center mb-8">
              <div className="relative">
                ...
                <div className="relative w-24 h-24 bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center shadow-xl">
            ...
            {/* Title */}
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-green-600 to-emerald-600 dark:from-green-400 dark:to-emerald-400 bg-clip-text text-transparent pb-2 leading-tight">
              {dict?.termsConditions || "Terms & Conditions"}
            </h1>
            ...
            <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-3xl p-8 border border-gray-200 dark:border-gray-700 shadow-lg">
              <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                {dict?.underConstructionMessage ||
                  "We're working hard to bring you something amazing. This page will be available soon with our complete terms and conditions."}
              </p>
            </div>

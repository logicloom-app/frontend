    ...
    <div className="w-full max-w-7xl p-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Manage your blog posts, create new content
          </p>
        </div>
        <Button
          onClick={handleOpenCreateModal}
          className="flex items-center gap-2 px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl font-semibold"
        >
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  Previous
                </button>
      ...
      <Dialog open={tagModalOpen} onOpenChange={setTagModalOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <form onSubmit={handleTagSubmit} className="space-y-6">
            ...
            <DialogFooter>
              <Button type="button" variant="outline" onClick={handleCloseTagModal}>
                Cancel
              </Button>
              <Button
                type="submit"
      ...
      <Dialog open={deleteTagModalOpen} onOpenChange={setDeleteTagModalOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <DialogFooter>
            <Button type="button" variant="outline" onClick={handleCancelDeleteTag}>
              Cancel
            </Button>
            <Button
              type="button"
